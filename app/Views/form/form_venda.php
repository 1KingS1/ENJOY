...
<form method="post">
    ...
    <p>
    <label><?= lang("form/form_venda.vend") ?>:</label>
    ...
    <p>
    <label><?= lang("form/form_venda.client") ?>:</label>
...
<a href="<?= Base_url('Venda/');?>"><?= lang("form/form_venda.back") ?></a>
